...
$table = $installer->getConnection()
    ...
    ->addIndex(
        $installer->getIdxName('nemo_addimage/customerImage', array('id', 'product_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('id', 'product_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE)
    )
    ->addForeignKey(
        $installer->getFkName('nemo_addimage/customerImage', 'product_id', 'catalog/product', 'entity_id'),
